/* -------------------------------------------------------
   ...
   - parallax
   - basic interactions (nav, scroll, fake booking form)
-------------------------------------------------------- */
...
const LANG_STORAGE_KEY = "lang";           // same as your original
...
// initial language (without pushing URL so gate can still change it)
...
/* ---------- Basisinteractie (nav, smooth scroll, fake booking form) ---------- */

// Mobiele navigatie togglen (safe-guarded)
...
// Eenvoudige client-side validatie en “fake” submit voor boekingsformulier (optional)
